...
export default function Footer() {
  ...
  const sectionRef = useGSAPSectionAnimation({ y: 30, scale: 0.98, duration: 0.8 });
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href="#experience" className="block text-muted-foreground hover:text-primary transition-colors duration-300">Experience</a>
            </div>
          </div>
        </div>
